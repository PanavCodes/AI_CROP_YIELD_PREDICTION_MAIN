      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold text-soil-dark dark:text-white hidden sm:block">
              CropPredict AI
            </span>
          </div>
              ...
              <AnimatePresence>
                {profileDropdownOpen && (
                  <motion.div
                    ...
                    className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-600 py-1 z-50"
                  >
                    ...
                    >
                      <Link
                        ...
                        className="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 dark:text-gray-200 transition-colors"
                      >
            ...
            <div className="px-4 py-4 space-y-2">
              {navItems.map((item, index) => {
                ...
                return item.disabled ? (
                  <motion.div
                    ...
                    className="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-400 dark:text-gray-500 cursor-not-allowed"
                    title={t('navigation.completeDataInputFirst')}
                  >
                    <Icon />
              ...
              >
                ...
                <button
                  ...
                  className="flex items-center gap-3 px-4 py-3 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors w-full mt-2"
                >
                  <FiLogOut />
                  <span>{t('logout')}</span>
                </button>
